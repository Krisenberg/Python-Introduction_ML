...
def exploratoryDataAnalysis(data_dir_path:str, country_name:str, eda_dir: str) -> None:
    data_path = data_dir_path + country_name + f'\\{country_name}_data.csv'
    data = pd.read_csv(data_path)
...
def generalEDA(data_dir_path:str, general_dir:str, eda_dir: str) -> None: 
    data_path = data_dir_path + general_dir + f'general_data.csv'
    data = pd.read_csv(data_path)
    report = pdp.ProfileReport(data)
    report_path = data_dir_path + eda_dir + f'general_eda.html'
    report.to_file(report_path)
