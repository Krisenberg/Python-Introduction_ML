...
def createGridSearch(X_train_scaled: ndarray, X_test_scaled: ndarray,
                     ...
                     param_grid: Dict[str, List[Any]], countryName: str,
                     output_text_file: str) -> Optional[Tuple[GridSearchCV, float]]:

    file_to_write = open(output_text_file, "a")

    scoring = ['neg_mean_squared_error']
    grid_search = GridSearchCV(model, param_grid=param_grid, cv=None,
